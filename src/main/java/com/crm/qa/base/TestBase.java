...
public class TestBase {
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\Users\\Sai\\workspace\\MavenProjects\\FreeCRMTest\\src\\main\\java\\com\\crm\\qa\\config\\config.properties");
	...
	public static void initialization(){
		...
		//here you have to register WebEventListener object to EventFiringWebDriver
		e_driver.register(eventListener);
		driver = e_driver; //assigning e_driver to driver
